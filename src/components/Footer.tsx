        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-400 text-lg leading-relaxed mb-6 max-w-md">
              Revolutionize your brand and marketing workflow with our comprehensive suite of AI-powered tools designed to enhance creativity and deliver exceptional results.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/ad-critic" className="text-slate-400 hover:text-white transition-colors">
                  Ad Critic
                </Link>
              </li>
              <li>
                <Link href="/brandchat" className="text-slate-400 hover:text-white transition-colors">
                  BrandChat
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <span className="text-slate-400 text-sm">
                Powered by OpenAI & Advanced AI Technologies
              </span>
